...
#define STRING_CONFIG_H_AUTHOR "KIHOPE" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TEVO Tarantula SKR 1.3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 800, 3400 }
